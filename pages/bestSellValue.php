...
<div class="container-fluid" style="padding:0px 30px 0px 30px;margin-top:-20px;">
  <div class="row">
    ...
    <?php page_menu(); ?>
            ...
            <div class="col-md-qw">
              <h1 class="page-header">Best Sell Value <small>(As of <?php echo date('l jS \of F Y'); ?>)</small></h1>
                  ...
                  <?php 
                    ...
                    while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
                      ...
                      echo "<tr><td>";
                      if ($i == 0) { echo '<i class="fa fa-star-half-o" style="color:gold;"></i> '; } 
                      else if($i == 1) {  echo '<i class="fa fa-star-half-o" style="color:silver;"></i> '; }
                      else if($i == 2) {  echo '<i class="fa fa-star-half-o" style="color:brown;"></i> '; } else {}
                      $tick = $row["ticker"]; $buy_value = $row["buy_value"];
                      echo $row['ticker'] . "</td><td>"  . $row['name'] . "</td><td>"  . $row['next_increase'] . "</td><td>"  . $row['pct_of_next_increase'] . "</td><td>" . $row['avg_increase_percent'] . "</td><td>" . $row['buy_value'] . "</td></tr>";
                      $i++;
                    }
                  ?>
